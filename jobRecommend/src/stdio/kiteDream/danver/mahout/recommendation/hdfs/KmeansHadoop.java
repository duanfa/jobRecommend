package stdio.kiteDream.danver.mahout.recommendation.hdfs;
...
public class KmeansHadoop {
	private static final String HDFS = "hdfs://server128:9000";

	public static void main(String[] args) throws Exception {
		String localFile = "src/datafile/randomData.csv";
